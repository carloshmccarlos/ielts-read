...
export function generateArticleStructuredData(article: Article, slug?: string) {
  ...
  return {
    ...
    "articleSection": article.Category?.name || "Reading Practice",
    "wordCount": wordCount,
    "inLanguage": "en-US",
    "about": {
      "@type": "Thing",
      "name": "IELTS Reading Preparation"
    },
    "audience": {
...
export function generateWebsiteStructuredData() {
  ...
  return {
    ...
    "url": baseUrl,
    "description": "Comprehensive IELTS reading practice platform with articles, exercises, and expert guidance to improve English reading comprehension skills.",
    "logo": {
      "@type": "ImageObject",
      "url": `${baseUrl}/logo.png`,
      "width": 200,
