...
export default function LexicalaTestDemo({ ieltsWords, ieltsWordsCount }: Props) {
  ...
  const playPronunciation = async (word: string) => {
    ...
    try {
      // First try to use audio URL from dictionary API if available
      if (wordDefinition?.audioUrl && selectedWord === word) {
        try {
