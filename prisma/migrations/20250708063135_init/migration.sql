-- CreateEnum
CREATE TYPE "IeltsWordsCount" AS ENUM ('count_20', 'count_30', 'count_40');
...
CREATE TABLE "Article" (
    ...
    "articleWordsCount" INTEGER NOT NULL DEFAULT 0,
    "ieltsWordsCount" INTEGER NOT NULL DEFAULT 0,
    "ieltsWords" TEXT[] DEFAULT ARRAY[]::TEXT[],
...
CREATE TABLE "user" (
    ...
    "image" TEXT,
    "masterNotice" BOOLEAN NOT NULL DEFAULT false,
    "markNotice" BOOLEAN NOT NULL DEFAULT false,
    "finishNotice" BOOLEAN NOT NULL DEFAULT false,
